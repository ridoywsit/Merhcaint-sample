...
const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="flex items-center">
      <button
        type="button"
        className="relative flex items-center justify-center p-2 py-[8.5px] ml-0 bg-white border rounded-l border-r-0 border-slate-300  cursor-pointer hover:bg-gray-200 text-merchaint-text-dark-grey"
      ...
      <button
        type="button"
        className="relative flex items-center justify-center p-2 py-[8.5px] ml-0 bg-white border rounded-r border-slate-300  cursor-pointer text-merchaint-text-dark-grey hover:bg-gray-200"
